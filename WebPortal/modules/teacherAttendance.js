    ...
    try {
        ...
        if (data.status === "success" && data.list && data.list.length > 0) {
            ...
            tbody.innerHTML = data.list.map(t => {
                ...
                return `
                    <tr>
                        <td class="ps-4 fw-bold text-secondary text-truncate" style="width: 20%; max-width: 0;" title="${t.name}">
                            ${t.name}
                        </td>
                        <td class="text-success fw-bold" style="width: 40%;">${checkIn}</td>
                        <td class="text-danger fw-bold" style="width: 40%;">${checkOut}</td>
                    </tr>
                `;
            }).join('');
        } else {
