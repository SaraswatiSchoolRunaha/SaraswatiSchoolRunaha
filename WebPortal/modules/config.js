...
export const sheetUrls = {
    'Database': 'https://script.google.com/macros/s/AKfycby3CDn1RnFNmns-aIU4HT14w5QmBnKSfU6Ymp26kBwnc7K0ysoKvsDYU1bw1Mx3VDkn/exec',
...
export const permissions = {
    ...
    'teacher': {
        'डैशबोर्ड': [], 
        'छात्र मॉड्यूल': ['छात्र प्रोफ़ाइल', 'छात्र फोटो अपडेट'], 
        'उपस्थिति मॉड्यूल': ['उपस्थिति डैशबोर्ड','दैनिक उपस्थिति','उपस्थित छात्रों की सूची','अनुपस्थित छात्रों की', 'नवीन छात्र सूची','कक्षावार छात्र सूची'],
        'फीस मॉड्यूल':[],
        'TC मॉड्यूल': [],
        'Exam मॉड्यूल':[],
        'Admit Card मॉड्यूल':[],
        'शिक्षक मॉड्यूल': ['शिक्षक उपस्थिति']
    },
    'principal': {
        'डैशबोर्ड': [], 
