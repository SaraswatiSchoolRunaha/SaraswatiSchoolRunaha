...
export const translations = {
    ...
    'EN': {
        ...
        'छात्र प्रमोट': 'Student Promote', 'छात्र प्रोफ़ाइल': 'Student Profile', 'छात्र फोटो अपडेट': 'Photo Update', 'छात्र समग्र अपडेट': 'Samagra Update', 'छात्र आधार अपडेट': 'Aadhaar Update', 'छात्र बैंक खाता': 'Bank Account','छात्र आईडी जोड़ें' : 'Link Student ID',
...
export const permissions = {
    'admin': {
        'डैशबोर्ड': [],
        'छात्र मॉड्यूल': ['छात्र आईडी जोड़ें','छात्र प्रमोट', 'छात्र प्रोफ़ाइल', 'छात्र फोटो अपडेट', 'छात्र समग्र अपडेट', 'छात्र आधार अपडेट', 'छात्र बैंक खाता'],
    ...
    'teacher': {
        ...
        'उपस्थिति मॉड्यूल': ['उपस्थिति डैशबोर्ड','दैनिक उपस्थिति','उपस्थित छात्रों की सूची','अनुपस्थित छात्रों की],
        'फीस मॉड्यूल':[],
        'TC मॉड्यूल': [],
        'Exam मॉड्यूल':[],
        'Admit Card मॉड्यूल':[],
